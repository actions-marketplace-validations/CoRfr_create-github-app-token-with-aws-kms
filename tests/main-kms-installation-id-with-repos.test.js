...
// Test KMS authentication with direct installation ID and repositories
await test(() => {
  ...
  process.env["INPUT_REPOSITORIES"] = "create-github-app-token";
});

console.log("✓ KMS installation-id with repositories test passed");
